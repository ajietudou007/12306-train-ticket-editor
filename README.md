...
![Version](https://img.shields.io/badge/version-6.2.8-2E7CF6)
...
**🚀 在线使用**：<https://ajietudou007.github.io/12306-train-ticket-editor/?v=6.2.8>

> 💡 链接自带版本参数 `?v=6.2.8` 以绕过 CDN / 浏览器缓存。若页面仍显示旧版本，请强制刷新（`Cmd/Ctrl + Shift + R`）。
...
```text
GitHub火车票编辑器/
├── index.html      # 应用本体（V6.2.8，含全部样式 / 脚本 / 内嵌底图资源）
├── README.md
├── CHANGELOG.md    # 版本日志（V4.0 → V6.2.8）
├── LICENSE         # MIT
